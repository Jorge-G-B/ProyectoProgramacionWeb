    ...
    public class ProfesoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'EscuelawebContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Especialidad")] Profesore profesore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Email,Especialidad")] Profesore profesore)
        {
            if (id != profesore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EscuelawebContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
