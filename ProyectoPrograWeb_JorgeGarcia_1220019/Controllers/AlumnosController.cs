    ...
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Alumnos != null ? 
                          ...
                          Problem("Entity set 'EscuelawebContext.Alumnos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Edad,Email")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Edad,Email")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EscuelawebContext.Alumnos'  is null.");
            }
            var alumno = await _context.Alumnos.FindAsync(id);
            if (alumno != null)
            {
